...
const translations = {
  ...
  uk: {
    header: {
      title: "🎭 Майстер Переконання: Чат-Пригода 🎮",
      subtitle:
        "Випробуй свої комунікативні навички у віртуальних світах! Переконуй, зачаровуй та долай персонажів за обмежену кількість повідомлень. Чи зможеш ти підкорити їх серця та розуми?",
    },
    categories: {
  ...
  en: {
    header: {
      title: "🎭 Master of Persuasion: Chat Adventure 🎮",
      subtitle:
        "Test your communication skills in virtual worlds! Persuade, charm, and overcome characters within a limited number of messages. Can you conquer their hearts and minds?",
    },
    categories: {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Застосування поточних перекладів
